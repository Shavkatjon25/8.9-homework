    ...
    <div className="max-w-[1392px] ml-auto mr-auto border box-border py-6 px-4 border-[ #E2E2EA] rounded-[24px]" >
      ...
      <button className="btn_oq btn">
                ...
                <button className="btn_kok btn">
                    ...
                    <svg className="y360" width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M15.09 19.92L8.57003 13.4C7.80003 12.63 7.80003 11.37 8.57003 10.6L15.09 4.07999" stroke="#fff" strokeWidth="1.5" strokeMiterlimit="10" strokeLinecap="round" strokeLinejoin="round"/>
                        </svg>
                </button>
      </div>
      <Yonalish/>
